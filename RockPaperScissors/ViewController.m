...
-(void)showWinner
{
    ...
    computerWon = [judge didComputerWin: computerHandLabel.text from: playerHandLabel.text];
    
    // YES;replace the YES with a call to your custom Judge class
...
-(void)countDown
{
    ...
    if (count == 0) {
        ...
        ComputerHand *hand = [[ComputerHand alloc]init];

        
        computerHandLabel.text = [hand randomizer];
